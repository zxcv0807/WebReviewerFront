            ...
            <div className="p-4">
              <div className="flex justify-between items-center">
                <div className="flex-1">
                  ...
                  <span className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${getReasonColor(site.reason)}`}>
            ...
            {isExpanded && (
              <div className="border-t border-gray-100 p-4 bg-gray-50">
                <div className="bg-red-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-red-800 mb-2">신고 사유 및 설명</h4>
